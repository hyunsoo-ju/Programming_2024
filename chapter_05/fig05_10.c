...
int maindfd( void )
{ 
   auto int sum=1; /* sum of rolled dice */
   int myPoint; /* point earned */

   enum Status gameStatus; /* can contain CONTINUE, WON, or LOST */

   /*printf("enum gameStateus %d", WON);
...
int rollDice( void )
{
   auto int die1; /* first die */
   auto int die2; /* second die */
